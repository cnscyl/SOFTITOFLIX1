...
namespace SOFTITOFLIX.Data
{
    public class DataInitialization
    {
        ...
        private readonly RoleManager<SOFTITOFLIXRole> _roleManager;

        MediaConverter _mediaConverter = new MediaConverter();

        public DataInitialization(SOFTITOFLIXContext context, SignInManager<SOFTITOFLIXUser> signInManager, RoleManager<SOFTITOFLIXRole> roleManager)
        {
            _context = context;
        ...
        public void CreateAdminUser()
        {
            ...
            if (_signInManager.UserManager.Users.Count() <= 2)
            {
                ...
                SOFTITOFLIXUser NewUser = userConverter.Convert(newUserRequest);
        ...
        public void CreateRoles()
        {
            ...
            SOFTiTOFLIXRole = new SOFTITOFLIXRole("Administrator");
            _roleManager.CreateAsync(SOFTiTOFLIXRole).Wait();
