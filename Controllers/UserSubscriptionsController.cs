...
namespace SOFTITOFLIX.Controllers
{
    ...
    public class UserSubscriptionsController : ControllerBase
    {
        ...
        public UserSubscriptionsController(SOFTITOFLIXContext context, UserManager<SOFTITOFLIXUser> userManager)
        {
            _context = context;
        ...
        public void PostUserSubscription(string email, short planId)
        {
            ...
            //If payment succesfull
            {
                ...
                SOFTITOFLIXUser? currentUser = _userManager.FindByEmailAsync(email).Result;
