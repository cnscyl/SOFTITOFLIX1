...
using SOFTITOFLIX.DTO.Responses.EpisodeResponses;
using SOFTITOFLIX.DTO.Requests.EpisodeRequests;
...
namespace SOFTITOFLIX.Controllers
{
    ...
    public class EpisodesController : ControllerBase
    {
        ...
        public EpisodesController(SOFTITOFLIXContext context, UserManager<SOFTITOFLIXUser> userManager)
        {
            _context = context;
